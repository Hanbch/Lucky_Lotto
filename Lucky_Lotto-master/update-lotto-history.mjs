 ...
 * 사용: node update-lotto-history.mjs  (저장소 루트에 둘 때)
 */
import fs from "fs";
...
// 스크립트와 같은 폴더에 lotto_history.json 이 있으면 그 폴더를 루트로 사용
const ROOT = fs.existsSync(path.join(__dirname, "lotto_history.json"))
	? __dirname
